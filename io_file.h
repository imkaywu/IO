...
int ply_read_1(char *fname, double *pt, double *n, double *rgb, double *face, double *grid);

int ply_write_1(char *fname, double *pt, double *n, double *rgb, double *face, double *grid, int num_vertices, int num_faces, int row, int col);

int ply_write_list(char *fname, double *grid, int row, int col);
